...
gc_pmdata_locs <- function(DATA_DIR = "/home/johannes/Dropbox/phd/pmdata/data_sources/") {
    ...
    data_locs <- list(
        ## PMDB section
        PMDB_FILE                    = paste0(DATA_DIR, "pmdb/Private museum database_v20.csv"),
        ...
        FILE_LOTSEARCH_ARTFACTS_MATCH_MNL = paste0(DATA_DIR, "lotsearch/match_manual.csv"),
        ## EGMUS
        ...
        ## the art newspaper
        DIR_TANP_STRUC = paste0(DATA_DIR, "artnewspaper/csv/struc/"),
        FILE_TANP_CITY_ID = paste0(DATA_DIR, "artnewspaper/csv/tanp_city_id.csv"),
        FILE_TANP_CITY_LINKS = paste0(DATA_DIR, "artnewspaper/csv/tanp_city_link.csv"),
        FILE_TANP_MUCI_ID = paste0(DATA_DIR, "artnewspaper/csv/tanp_muci_id.csv"),
        FILE_TANP_MUCI_LINKS = paste0(DATA_DIR, "artnewspaper/csv/tanp_muci_links.csv"),
        FILE_TANP_MUYR = paste0(DATA_DIR, "artnewspaper/csv/tanp_muyr.csv"),
        FILE_LINKS_AF_TANP = paste0(paste0(DATA_DIR, "artnewspaper/csv/links_af_muci.csv"))
    )
