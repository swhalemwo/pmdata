...
#' read the time-ranking file
#' @param ARTNEWS_TIME_FILE file with time-ranking data, generated by artnews_parsing_all.py
#' @export
...
check_artnews_pmdb_match <- function(dt_pmdb_person_matchy, pmdb_person_id_each) {
    ...
    dt_res <- data.table(pmdb_person_id = pmdb_person_id_each, an_person_id = APE_ID)
