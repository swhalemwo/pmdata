...
digraph D {
  ...
  PMDB_collectors [
		   label = "PMDB_collector_person | name | <ID>PMDB_collector_ID | around 700 "
		   ]
  ...
  PMDB_founder_collector_links [
				label = "PMDB_founder_collector_links | <founder_id> founder_id |
				<collector_id> collector_id | around 510"]
  
  // this is what has to be manually created, maybe I can use my MOW framework
  // this is what Luisa did 
  PMDB_collector_AN_collector_links[
				    label = "PMDB_collector_AN_collector_links |
				    <PMDB_collector> PMDB_collector_ID |
				    <AN_collector> AN_collector_ID"]
  ...
  PMDB_founders:founder_id -> PMDB_founder_collector_links:founder_id
  PMDB_founder_collector_links:collector_id -> PMDB_collectors:ID [dir=back]

  PMDB_collectors:ID -> PMDB_collector_AN_collector_links:PMDB_collector
  AN_person:ID_person -> PMDB_collector_AN_collector_links:AN_collector
